...
public class home3 {
    ...
    public static void task1() {
        ...
        ArrayList<Integer> num_arr = new ArrayList<>(); // список для чисел
        Random rnd = new Random();

        for (int i = 0; i < 10; i++) { // массив рандомных чисел от 1 до 100
    ...
    public static void task3() {
        System.out.println("Сложна, сложна, ничего не понимаю!!! :c" +
        "\n*пошел изучать Герберта Шилдта \"Руководство для начинающих\"");
